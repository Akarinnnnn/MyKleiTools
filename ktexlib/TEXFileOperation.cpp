...
ktexlib::KTEXFileOperation::mipmapv2 ktexlib::KTEXFileOperation::KTEXv2::GetRawMipmap(unsigned int 序号)
{
...
ktexlib::KTEXFileOperation::KTEXv2::GetImageArray(unsigned int 序号)
{
